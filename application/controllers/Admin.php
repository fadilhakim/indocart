...
class admin extends CI_Controller {
	...
	{
		$this->load->view('templates/v_t_meta-admin');
		$this->load->view('templates/v_menu-admin');
		$this->load->view('admin/home-admin');
		$this->load->view('templates/v_t_footer-admin');
	}
...
/*			echo $message;
	...
	public function edit_slider($id)
	{
		...
		$data['slider'] = $this->model_update->list_slider($id)->result();
	...
	public function edit_product($cat, $slug)
	{
