<?php  $this->load->view('templates/v_t_meta-admin'); ?>
    <body>

        <div class="text-center logo-alt-box">
            <a href="<?php echo base_url('home'); ?>" class="logo">
                <img src="<?php echo base_url('assets/images/indocart-logo.png'); ?>" style="width:15%;">
            </a>
        </div>
        ...
        <div class="wrapper-page">
        	...
        	<div class="m-t-30 card-box">
                <div class="text-center">
                    <h4 class="text-uppercase font-bold m-b-0">Sign In as : Admin Indocart</h4>
                </div>
