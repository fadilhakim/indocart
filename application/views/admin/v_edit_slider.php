                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="card-box">
                                ...
                                <form class="form-horizontal group-border-dashed" enctype="multipart/form-data" action="<?php echo base_url('admin/insert/slider'); ?>"  method="post">
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo base_url('assets/images/slider').'/'.$s->silder_image; ?>" class="img-responsive"></td>
                                            <td>
